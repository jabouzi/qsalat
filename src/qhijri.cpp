...
QStringList Qhijri::isToString(int y, int m, int d, int diff = 0){
    ...
    QStringList ress;
    ress << QString::number(res[0]);
    ress << months[res[1]-1];
    ress << monthsH[res[1]-1];
    ress << QString::number(res[2]);
    delete[] res;
    return ress;
}

//christian calendar to string
QStringList Qhijri::chrToString(int y, int m, int d, int diff = 0){
