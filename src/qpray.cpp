...
void Qpray::getDatePrayerTimes(int year, int month, int day, double latitude, double longitude, double timeZone, QString * prayerTimes)
{
...
double Qpray::sunPosition(double jd, int flag)
{
...
void Qpray::computeTimes(double * times)
{
    dayPortion(times);
...
// compute prayer times at given julian date
void Qpray::computeDayTimes(QString * prayerTimes)
{
...
void Qpray::adjustTimes(double* times)
{
    for (int i=0; i<7; i++)
...
void Qpray::adjustTimesFormat(double* times, QString * prayerTimes)
{
...
void Qpray::adjustHighLatTimes(double* times)
{
...
void Qpray::dayPortion(double * times)
{
    for (int i=0; i<7; i++)
        times[i] /= 24;
    //return times;
