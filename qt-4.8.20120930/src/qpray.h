...
public:
    ...
    void getDatePrayerTimes(int, int , int , double , double , double, QString * prayerTimes);
    ...
    double sunPosition(double, int flag);
    ...
    // compute prayer times at given julian date
    void computeDayTimes(QString *prayerTimes);
    ...
    void adjustTimesFormat(double*, QString *prayerTimes);
