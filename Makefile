...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Fri Apr 23 07:08:26 2010
# Project:  Qsalat.pro
# Template: app
# Command: /opt/qtsdk-2010.02/qt/bin/qmake -unix -o Makefile Qsalat.pro
#############################################################################
...
INCPATH       = -I/opt/qtsdk-2010.02/qt/mkspecs/linux-g++ -I. -I/opt/qtsdk-2010.02/qt/include/QtCore -I/opt/qtsdk-2010.02/qt/include/QtNetwork -I/opt/qtsdk-2010.02/qt/include/QtGui -I/opt/qtsdk-2010.02/qt/include/QtXml -I/opt/qtsdk-2010.02/qt/include/phonon -I/opt/qtsdk-2010.02/qt/include/QtWebKit -I/opt/qtsdk-2010.02/qt/include -I/opt/qtsdk-2010.02/qt/include/phonon_compat -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/opt/qtsdk-2010.02/qt/lib
LIBS          = $(SUBLIBS)  -L/opt/qtsdk-2010.02/qt/lib -lQtWebKit -L/opt/qtsdk-2010.02/qt/lib -L/usr/X11R6/lib -L/home/berlin/dev/qt-4.6.2-opensource-shipping/this_path_is_supposed_to_be_very_long_hopefully_this_is_long_enough/qt/lib -lQtXmlPatterns -lphonon -lQtDBus -lQtXml -lQtGui -lQtNetwork -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/qsalat.cpp \
		...
		src/domparser.cpp \
		src/alarm.cpp build/moc_qsalat.cpp \
...
Makefile: Qsalat.pro  /opt/qtsdk-2010.02/qt/mkspecs/linux-g++/qmake.conf /opt/qtsdk-2010.02/qt/mkspecs/common/g++.conf \
		/opt/qtsdk-2010.02/qt/mkspecs/common/unix.conf \
		/opt/qtsdk-2010.02/qt/mkspecs/common/linux.conf \
		/opt/qtsdk-2010.02/qt/mkspecs/qconfig.pri \
		/opt/qtsdk-2010.02/qt/mkspecs/features/qt_functions.prf \
...
compiler_moc_header_make_all: build/moc_qsalat.cpp build/moc_qqibla.cpp build/moc_qlocation.cpp build/moc_qaudio.cpp build/moc_qmonthly.cpp build/moc_qyearly.cpp build/moc_qworldTime.cpp build/moc_qcalculation.cpp build/moc_qhijridate.cpp build/moc_dsingleapplication.cpp build/moc_alarm.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_qsalat.cpp build/moc_qqibla.cpp build/moc_qlocation.cpp build/moc_qaudio.cpp build/moc_qmonthly.cpp build/moc_qyearly.cpp build/moc_qworldTime.cpp build/moc_qcalculation.cpp build/moc_qhijridate.cpp build/moc_dsingleapplication.cpp build/moc_alarm.cpp
build/moc_qsalat.cpp: build/ui_salat.h \
		...
		src/alarm.h \
		src/qsalat.h
	/opt/qtsdk-2010.02/qt/bin/moc $(DEFINES) $(INCPATH) src/qsalat.h -o build/moc_qsalat.cpp

build/moc_qqibla.cpp: build/ui_qibla.h \
		src/domparser.h \
		src/qqibla.h
	/opt/qtsdk-2010.02/qt/bin/moc $(DEFINES) $(INCPATH) src/qqibla.h -o build/moc_qqibla.cpp
...
build/moc_qlocation.cpp: build/ui_location.h \
		...
		src/qpray.h \
		src/qlocation.h
	/opt/qtsdk-2010.02/qt/bin/moc $(DEFINES) $(INCPATH) src/qlocation.h -o build/moc_qlocation.cpp

build/moc_qaudio.cpp: build/ui_audio.h \
		src/domparser.h \
		src/qaudio.h
	/opt/qtsdk-2010.02/qt/bin/moc $(DEFINES) $(INCPATH) src/qaudio.h -o build/moc_qaudio.cpp
...
build/moc_qmonthly.cpp: build/ui_monthly.h \
		...
		src/domparser.h \
		src/qmonthly.h
	/opt/qtsdk-2010.02/qt/bin/moc $(DEFINES) $(INCPATH) src/qmonthly.h -o build/moc_qmonthly.cpp
...
build/moc_qyearly.cpp: build/ui_yearly.h \
		...
		src/domparser.h \
		src/qyearly.h
	/opt/qtsdk-2010.02/qt/bin/moc $(DEFINES) $(INCPATH) src/qyearly.h -o build/moc_qyearly.cpp

build/moc_qworldTime.cpp: build/ui_worldtime.h \
		src/qworldTime.h
	/opt/qtsdk-2010.02/qt/bin/moc $(DEFINES) $(INCPATH) src/qworldTime.h -o build/moc_qworldTime.cpp

build/moc_qcalculation.cpp: build/ui_calculation.h \
		src/domparser.h \
		src/qpray.h \
		src/qcalculation.h
	/opt/qtsdk-2010.02/qt/bin/moc $(DEFINES) $(INCPATH) src/qcalculation.h -o build/moc_qcalculation.cpp

build/moc_qhijridate.cpp: build/ui_hijri.h \
		src/qhijri.h \
		src/domparser.h \
		src/qhijridate.h
	/opt/qtsdk-2010.02/qt/bin/moc $(DEFINES) $(INCPATH) src/qhijridate.h -o build/moc_qhijridate.cpp

build/moc_dsingleapplication.cpp: src/dsingleapplication.h
	/opt/qtsdk-2010.02/qt/bin/moc $(DEFINES) $(INCPATH) src/dsingleapplication.h -o build/moc_dsingleapplication.cpp

build/moc_alarm.cpp: src/alarm.h
	/opt/qtsdk-2010.02/qt/bin/moc $(DEFINES) $(INCPATH) src/alarm.h -o build/moc_alarm.cpp
...
qrc_salat.cpp: salat.qrc \
	...
	/opt/qtsdk-2010.02/qt/bin/rcc -name salat salat.qrc -o qrc_salat.cpp

qrc_qibla.cpp: qibla.qrc \
		/usr/share/qsalat/images/boussole.png
	/opt/qtsdk-2010.02/qt/bin/rcc -name qibla qibla.qrc -o qrc_qibla.cpp
...
qrc_worldtime.cpp: worldtime.qrc \
	...
	/opt/qtsdk-2010.02/qt/bin/rcc -name worldtime worldtime.qrc -o qrc_worldtime.cpp
...
build/ui_salat.h: ui/salat.ui
	/opt/qtsdk-2010.02/qt/bin/uic ui/salat.ui -o build/ui_salat.h

build/ui_qibla.h: ui/qibla.ui
	/opt/qtsdk-2010.02/qt/bin/uic ui/qibla.ui -o build/ui_qibla.h

build/ui_hijri.h: ui/hijri.ui
	/opt/qtsdk-2010.02/qt/bin/uic ui/hijri.ui -o build/ui_hijri.h

build/ui_worldtime.h: ui/worldtime.ui
	/opt/qtsdk-2010.02/qt/bin/uic ui/worldtime.ui -o build/ui_worldtime.h

build/ui_location.h: ui/location.ui
	/opt/qtsdk-2010.02/qt/bin/uic ui/location.ui -o build/ui_location.h

build/ui_audio.h: ui/audio.ui
	/opt/qtsdk-2010.02/qt/bin/uic ui/audio.ui -o build/ui_audio.h

build/ui_calculation.h: ui/calculation.ui
	/opt/qtsdk-2010.02/qt/bin/uic ui/calculation.ui -o build/ui_calculation.h

build/ui_monthly.h: ui/monthly.ui
	/opt/qtsdk-2010.02/qt/bin/uic ui/monthly.ui -o build/ui_monthly.h

build/ui_yearly.h: ui/yearly.ui
	/opt/qtsdk-2010.02/qt/bin/uic ui/yearly.ui -o build/ui_yearly.h

build/ui_player.h: ui/player.ui
	/opt/qtsdk-2010.02/qt/bin/uic ui/player.ui -o build/ui_player.h
...
build/alarm.o: src/alarm.cpp src/alarm.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/alarm.o src/alarm.cpp
...
build/moc_alarm.o: build/moc_alarm.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_alarm.o build/moc_alarm.cpp
