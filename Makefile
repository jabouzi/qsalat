...
# Generated by qmake (2.01a) (Qt 4.6.0) on: Fri Apr 23 09:02:47 2010
# Project:  Qsalat.pro
# Template: app
...
LIBS          = $(SUBLIBS)  -L/usr/local/Trolltech/Qt-4.6.0/lib -lQtWebKit -L/usr/local/Trolltech/Qt-4.6.0/lib -L/usr/X11R6/lib -lQtXmlPatterns -lphonon -lQtDBus -lQtXml -lQtGui -lQtNetwork -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
build/moc_alarm.cpp: src/alarm.h
	/usr/local/Trolltech/Qt-4.6.0/bin/moc $(DEFINES) $(INCPATH) src/alarm.h -o build/moc_alarm.cpp
